...
export const toolFamilies = [
  {
    ...
    preparation:
      'Create an ExFu Library folder somewhere you can find it again. Start a fresh session in your chosen app with access to that folder.',
    setupPrompt:
  ...
  },
  {
    ...
    preparation:
      'Open a project folder in your local agent app. Choose one piece of work you want to plan; you do not need to decide the whole project at once.',
    setupPrompt:
    ...
    setupNote:
      'Planning can be useful on its own. If you want delegation between models, ask your agent to check the extra tools and accounts required before setting that up.',
  ...
  },
  {
    ...
    preparation:
      'Open the project in your local agent app. The visualiser works with Git history and needs Python 3; ask your agent to check those prerequisites first.',
    setupPrompt:
    ...
    setupNote:
      'Use the record to see what changed and why. Ask your agent to explain how future work will be captured before you start relying on it.',
  ...
  },
  {
    ...
    preparation:
      'Begin a fresh session in your chosen app and bring a report, handover or explanation you would like to make more useful.',
    setupPrompt:
    ...
    setupNote:
      'Tell your agent who the reader is and how much context they have. You can ask for a clear human account while retaining the detailed record.',
    description:
