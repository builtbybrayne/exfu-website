# Project state — generated 2026-09-09T16:21:18Z

**Total events:** 99  ·  **Draft:** 2  ·  **Live:** 5  ·  **Dormant:** 0  ·  **Closed:** 5  ·  **Orphaned:** 0
...
- **(T2 itself)**
  ...
  - `T2-implementation` (9 events): entity.progressed → verification.tested → entity.progressed
...
- `M1-reviewable-design` (authored 2026-09-08, 9 commit(s) ago)
- `T3-review-home-and-service` (authored 2026-09-08, 9 commit(s) ago)
