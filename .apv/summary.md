# Project state — generated 2026-09-09T16:16:26Z

**Total events:** 97  ·  **Draft:** 2  ·  **Live:** 5  ·  **Dormant:** 0  ·  **Closed:** 5  ·  **Orphaned:** 0
...
- **(T2 itself)**
  ...
  - `T2-implementation` (8 events): verification.tested → entity.progressed → verification.tested
...
- `M1-reviewable-design` (authored 2026-09-08, 8 commit(s) ago)
- `T3-review-home-and-service` (authored 2026-09-08, 8 commit(s) ago)
