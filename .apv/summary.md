# Project state — generated 2026-09-11T14:23:01Z

**Total events:** 195  ·  **Draft:** 2  ·  **Live:** 5  ·  **Dormant:** 0  ·  **Closed:** 5  ·  **Orphaned:** 0
...
- **(T2 itself)**
  ...
  - `T2-implementation` (61 events): verification.tested → entity.progressed → verification.tested
...
- `M1-reviewable-design` (authored 2026-09-08, 36 commit(s) ago)
- `T3-review-home-and-service` (authored 2026-09-08, 36 commit(s) ago)
