# Project state — generated 2026-09-09T18:37:26Z

**Total events:** 129  ·  **Draft:** 2  ·  **Live:** 5  ·  **Dormant:** 0  ·  **Closed:** 5  ·  **Orphaned:** 0
...
- **(T2 itself)**
  ...
  - `T2-implementation` (25 events): verification.tested → entity.progressed → verification.tested
...
- `M1-reviewable-design` (authored 2026-09-08, 17 commit(s) ago)
- `T3-review-home-and-service` (authored 2026-09-08, 17 commit(s) ago)
...
- **plan**
  - `M1-reviewable-design`
  - `T3-review-home-and-service`
...
- `T3-support-and-visual-polish` (plan)
...
---
_12 entities · 23 relationships · 18 decisions._