# Project state — generated 2026-09-11T14:03:10Z

**Total events:** 192  ·  **Draft:** 2  ·  **Live:** 5  ·  **Dormant:** 0  ·  **Closed:** 5  ·  **Orphaned:** 0
...
- **(T2 itself)**
  ...
  - `T2-implementation` (59 events): verification.tested → entity.progressed → verification.tested
...
- `M1-reviewable-design` (authored 2026-09-08, 35 commit(s) ago)
- `T3-review-home-and-service` (authored 2026-09-08, 35 commit(s) ago)
